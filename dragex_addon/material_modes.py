...
class MultitextureMaterialMode(MaterialMode):
    @staticmethod
    def init(material, prev_mode):
...
class DragExMaterialModesProperties(bpy.types.PropertyGroup):
    ...
    multitexture_: bpy.props.PointerProperty(
        type=DragExMaterialModesMultitextureProperties
    )

    @property
    def multitexture(self) -> DragExMaterialModesMultitextureProperties:
...
material_modes_dict: dict[str, type[MaterialMode]] = {
    ...
    "MULTITEXTURE": MultitextureMaterialMode,
