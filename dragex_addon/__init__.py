...
classes = (
    ...
    oot_panels.DragExCollectionOoTPanelInProperties,
    oot_panels.DragExCollectionOoTPanelInDragExTab,
    oot_panels.DragExEmptyOoTPanelInProperties,
    oot_panels.DragExEmptyOoTPanelInDragExTab,
    oot_panels.DragExMeshOoTPanelInProperties,
    oot_panels.DragExMeshOoTPanelInDragExTab,
